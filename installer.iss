...
; Sidecar entrypoint (main.py + launcher)
Source: "sidecar\dist\sidecar\*"; \
    DestDir: "{#SidecarDir}"; \
    Flags: ignoreversion recursesubdirs createallsubdirs

; Python venv with all dependencies (ACE-Step, Basic Pitch, etc.)
; Installed next to sidecar\ so the launcher can find it at ..\venv\
Source: "sidecar\.venv\*"; \
    DestDir: "{pf}\AIMidiComposer\venv"; \
    Flags: ignoreversion recursesubdirs createallsubdirs
...
[Run]
; Firewall rule for sidecar localhost binding (python.exe in venv)
Filename: "netsh"; \
